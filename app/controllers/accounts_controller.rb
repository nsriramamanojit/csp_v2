...
=end
  ...
  def pdf_export
    ...
    kit.stylesheets << Rails.root.join('public', 'stylesheets', 'styles.css') #'/public/stylesheets/styles.css'
    send_data(kit.to_pdf, :filename => 'CSP_Account_Details.pdf', :type => 'application/pdf')
  ...
  def account_params
    params.require(:account).permit(:csp_code, :name, :account_number, :status, :created_by, :modified_by)
